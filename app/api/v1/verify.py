...
# server-side verification — superseded by client-side WebRTC ZKP (zkp_queue.html)
# passport data is now managed by Supabase/Next.js; these endpoints queried passport_material
# and passport_sustainability via integer FKs which don't match Supabase's UUID schema
# kept for reference; endpoints are not mounted (verify_router is commented out in main.py)
