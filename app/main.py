...
# from app.api.v1.verify import router as verify_router  # server-side verification — superseded by client-side WebRTC ZKP
from app.api.v1.p2p import router as p2p_router
from app.api.v1.signal_test import router as signal_router
# from app.api.v1.graph import router as graph_router   # neo4j — deferred
# from app.api.v1.admin import router as admin_router   # stubs — user management via supabase dashboard

app = FastAPI(title=settings.app_name, debug=settings.debug)
app.mount("/static", StaticFiles(directory="static"), name="static")
app.include_router(v1_router, prefix=settings.api_v1_prefix)      # health check
