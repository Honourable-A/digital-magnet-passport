# audit logging and composition helpers — not called by any active endpoint in current stager
# passport data is managed by Supabase/Next.js; composition disclosure deferred

# from app.models.audit_log import AuditLog

# def log_action(db, supabase_uid, action, entity_type, entity_id):
#     entry = AuditLog(supabase_uid=supabase_uid, action=action, entity_type=entity_type, entity_id=entity_id)
#     db.add(entry)
#     db.commit()
